...
public class TimeCalculations {
    ...
    public double calculateAnkomst(double currTid) {
        return this.xRS.next() + currTid;
    }

    public double calculatePlock(double currTid) {
        return this.pURS.next() + currTid;
    }

    public double calculateBetalnings(double currTid) {
        return this.bURS.next() + currTid;
    }
}
