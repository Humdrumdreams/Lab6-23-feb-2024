...
public class TestOptimize {
    ...
    public int metod2(double ankomstRate, long frö, double minKassaTid, double maxKassaTid, double minPlockTid, double maxPlockTid, double tidenSnabbköpetStänger) {
        int low = 1;
        ...
        while (low <= high) {
            ...
            int missadeKunder = metod1(mid, Integer.MAX_VALUE, ankomstRate, frö, minKassaTid, maxKassaTid, minPlockTid, maxPlockTid, tidenSnabbköpetStänger);
